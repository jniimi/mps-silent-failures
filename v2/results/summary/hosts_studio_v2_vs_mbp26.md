...
基準: **studio**。torch の版: 2.14.0。`uv run python compare_hosts.py --source results:studio --source results:mbp-macos26 --torch 2.14.0` で生成(`v2/` で実行)。
...
|---|---|---|---|
| 2.14.0 | fp16 | 4.211458e-04 / 0.00387〜0.00421(2 通り) | 4.211458e-04 / 0.00421 |
| 2.14.0 | fp32 | 1.539769e-06 / 1.15e-05〜1.54e-05(2 通り) | 1.539769e-06 / 1.54e-05 |
...
- 共通の点: 1572(基準 1794 点、mbp-macos26 1572 点)
- 分類が同じ: 1572、違う: 0
- 共通の点の基準側の分類: WRONG 97, err 214, ok 1261、mbp-macos26 側: WRONG 97, err 214, ok 1261
- 基準にしかない点: 222(final random full 54, probe random full 8, probe random sample 160)
